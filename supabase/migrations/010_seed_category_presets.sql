...
begin
  ...
  values (
    ...
    'keyword',
    'STARBUCKS,MCDONALDS,MCDONALD''S,CHIPOTLE,TIM HORTONS,WENDYS,BURGER KING,PIZZA HUT,SUBWAY,KFC,POPEYES,PANERA,A&W,HARVEY,SWISS CHALET,BOSTON PIZZA,KELSEY,MONTANA,RESTAURANT,CAFE,COFFEE,BISTRO,GRILL,PUB,DOORDASH,UBER EATS,SKIP THE DISHES,FOODORA,GRUBHUB,BANGKOK,THAI,CHINESE,INDIAN,MEXICAN,ITALIAN',
    'dining_out',
    5,
    0.8,
    true
  ...
  values (
    ...
    'keyword',
    'NETFLIX,SPOTIFY,AMAZON PRIME,DISNEY,APPLE MUSIC,CINEPLEX,LANDMARK,STEAM,STEAM GAMES,PLAYSTATION,NINTENDO,XBOX,MOVIE,THEATRE,CONCERT,STUBHUB,TICKETMASTER,LEGENDS MUSIC,MUSIC,CONCERT',
    'entertainment',
    5,
    0.8,
    true
  ...
  values (
    ...
    'keyword',
    'TICKETMASTER,STUBHUB,EVENTBRITE,CONCERT,FESTIVAL,CONFERENCE,EXPO,SHOW,PERFORMANCE,THEATRE,SPORTS EVENT,TOURNAMENT,EVENT',
    'events',
    5,
    0.8,
    true
  ...
  values (
    ...
    'keyword',
    'OCS,CANNABIS,MARIJUANA,WEED,DISPENSARY,CANNABIS STORE,CANNABIS RETAIL,CANNABIS CO,CANNABIS CORP,CANNABIS INC,CANNABIS LTD,CANNABIS SHOP,CANNABIS OUTLET,CANNABIS MARKET,CANNABIS SUPPLY,CANNABIS EXPRESS,CANNABIS CLUB,CANNABIS CAFE,CANNABIS LOUNGE',
    'cannabis',
    5,
    0.8,
    true
